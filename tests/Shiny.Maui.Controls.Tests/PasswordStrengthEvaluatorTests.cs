...
/// <summary>
/// The scorer's behaviour, which is where the interesting decisions live. These are pure — no
/// Application, no dispatcher — because the evaluator deliberately touches neither.
/// </summary>
