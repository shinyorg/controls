...
/// <summary>
/// How many chips in a <c>ChipGroup</c> may be selected at once.
/// </summary>
/// <remarks>
...
/// filters or actions that report a click and carry no state of their own.
/// </remarks>
public enum ChipSelectionMode
{
    /// <summary>No selection. Chips report clicks and nothing else.</summary>
    None,
