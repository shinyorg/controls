...
[![MAUI Floor Plan NuGet](https://img.shields.io/nuget/v/Shiny.Maui.Controls.FloorPlan.svg?label=Shiny.Maui.Controls.FloorPlan)](https://www.nuget.org/packages/Shiny.Maui.Controls.FloorPlan)
[![Blazor Floor Plan NuGet](https://img.shields.io/nuget/v/Shiny.Blazor.Controls.FloorPlan.svg?label=Shiny.Blazor.Controls.FloorPlan)](https://www.nuget.org/packages/Shiny.Blazor.Controls.FloorPlan)
[![MAUI Diagram NuGet](https://img.shields.io/nuget/v/Shiny.Maui.Controls.Diagram.svg?label=Shiny.Maui.Controls.Diagram)](https://www.nuget.org/packages/Shiny.Maui.Controls.Diagram)
[![Blazor Diagram NuGet](https://img.shields.io/nuget/v/Shiny.Blazor.Controls.Diagram.svg?label=Shiny.Blazor.Controls.Diagram)](https://www.nuget.org/packages/Shiny.Blazor.Controls.Diagram)
[![MAUI Gamepad NuGet](https://img.shields.io/nuget/v/Shiny.Maui.Controls.Gamepad.svg?label=Shiny.Maui.Controls.Gamepad)](https://www.nuget.org/packages/Shiny.Maui.Controls.Gamepad)
[![Blazor Gamepad NuGet](https://img.shields.io/nuget/v/Shiny.Blazor.Controls.Gamepad.svg?label=Shiny.Blazor.Controls.Gamepad)](https://www.nuget.org/packages/Shiny.Blazor.Controls.Gamepad)
...
[![Gantt Engine NuGet](https://img.shields.io/nuget/v/Shiny.Controls.Gantt.Shared.svg?label=Shiny.Controls.Gantt.Shared)](https://www.nuget.org/packages/Shiny.Controls.Gantt.Shared)
[![Floor Plan Engine NuGet](https://img.shields.io/nuget/v/Shiny.Controls.FloorPlan.Shared.svg?label=Shiny.Controls.FloorPlan.Shared)](https://www.nuget.org/packages/Shiny.Controls.FloorPlan.Shared)
[![Diagram Engine NuGet](https://img.shields.io/nuget/v/Shiny.Controls.Diagram.Shared.svg?label=Shiny.Controls.Diagram.Shared)](https://www.nuget.org/packages/Shiny.Controls.Diagram.Shared)
[![Gamepad Engine NuGet](https://img.shields.io/nuget/v/Shiny.Controls.Gamepad.Shared.svg?label=Shiny.Controls.Gamepad.Shared)](https://www.nuget.org/packages/Shiny.Controls.Gamepad.Shared)
...
| **[ButtonGroup](docs/controls/button-group.md)** | Related buttons joined into one segmented control, with optional selection |
...
| **[TagEntry](docs/controls/tag-entry.md)** | Free-text tags committed as removable chips, with delimiters, limits and validation |
| **[ChipGroup](docs/controls/chip-group.md)** | A bound set of chips, selectable singly or in any number, reporting the items themselves |
...
| **[Gamepad](docs/controls/gamepad.md)** | On-screen NES / SNES / Xbox / PlayStation controller that is a real Shiny.Gamepad `IGamepad` (add-on) |
...
| **[Floor Plan](docs/controls/floorplan.md)** | Rooms, walls, doors, cubicles, outlets and furniture on a pan/zoom surface — editor and seating-chart modes |
